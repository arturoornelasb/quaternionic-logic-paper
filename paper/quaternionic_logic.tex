...
connectives (AND, OR, implication) form a bounded residuated
lattice, equipped with an involutive negation (NOT). An $\SU$ group acts on truth values by quaternionic
...
\item A completeness theorem reducing G-lattice tautologies to
  $G^\sim$ (G\"odel logic with involutive negation) via a
  real-part independence lemma (Section~\ref{sec:completeness}).
