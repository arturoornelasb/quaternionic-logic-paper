...
equipped with a non-abelian group action. To our knowledge, no precedent for
this specific combination---residuated lattice with $\SU$
conjugation and real-part invariance---exists in the literature.
...
\midrule
Specialisations (2 exact + 4 interpretive) & --- & 0 & exact \\
...
The G-lattice inherits completeness from $G^\sim$ (G\"odel logic
with involutive negation) via the real-part independence lemma
(Theorem~\ref{thm:completeness}). The negation-free fragment
reduces to standard G\"odel--Dummett. The imaginary dimensions do
not alter tautologies---they enrich the surrounding structure.
